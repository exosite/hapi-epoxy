...
internals.convertToGlue = function(epoxyManifest) {
  var glueManifest = Hoek.clone(epoxyManifest, {shallow: ['plugins']});
...
exports.convertToEpoxy = function(glueManifest) {
  var epoxyManifest = Hoek.clone(glueManifest, {shallow: ['registrations']});
...
exports.bond = function(yamlContents, options) {
  ...
  var EPOXY_SCHEMA = Yaml.DEFAULT_SCHEMA.extend([EpoxyYamlType, EpoxyBoolYamlType, EpoxyNumberYamlType]);
